...
message88 = Message.create!({ author: user2, channel: channel4, body: "You’re not going to keep running this company from in here, okay?" })
message89 = Message.create!({ author: user2, channel: channel4, body: "That’s why you wanted me to give T-Bone a job, to pay him back for burning down the storage unit?" })
message90 = Message.create!({ author: user5, channel: channel4, body: "Michael, that’s ridiculous." })
message91 = Message.create!({ author: user2, channel: channel4, body: "Yeah, well, I’m not hiring him. No, we don’t have the money, Pop." })
message92 = Message.create!({ author: user5, channel: channel4, body: "There’s always money in the banana stand." })
message93 = Message.create!({ author: user2, channel: channel4, body: "The banana stand... you know, that’s exactly what this feels like." })
message94 = Message.create!({ author: user2, channel: channel4, body: "Like I’m still stuck in that hot booth all summer with you pulling the strings." })
message95 = Message.create!({ author: user5, channel: channel4, body: "What was I going to do? Put a kid in charge of a frozen banana stand?" })
message96 = Message.create!({ author: user2, channel: channel4, body: "Sure, that’s what I did. I just made my son the manager." })
message97 = Message.create!({ author: user5, channel: channel4, body: "George Michael is running the frozen banana stand now?" })
message98 = Message.create!({ author: user2, channel: channel4, body: "Yeah, that’s right, yeah. You sit with that, you think about that for a while." })
message99 = Message.create!({ author: user8, channel: channel4, body: "Well, now that we’ve got an employee, we can go have dinner." })
message100 = Message.create!({ author: user8, channel: channel4, body: "We throw away a banana for every buck we take so no one finds out." })
message101 = Message.create!({ author: user11, channel: channel4, body: "Wait a minute, I think you should do that math again." })
message102 = Message.create!({ author: user3, channel: channel4, body: "Why? Is it wrong?" })
message103 = Message.create!({ author: user8, channel: channel4, body: "It’s fine. He’s an arsonist, not an embezzler." })
